...
const projects = [
  {
    ...
    desc: "Designed and developed a scalable microservices-based ticket booking platform capable of handling high-concurrency seat reservations, secure payments, and real-time booking management.",
    features: [
  ...
  },
  {
    ...
    tech: ["React", "Express", "LLM APIs", "Node", "MongoDb"],
  ...
  },
  {
    ...
    tech: ["React", "Express", "Node", "Machine Learning", "APIs"],
...
function ProjectCard({ project, isInView }) {
  ...
  return (
    ...
    >
      ...
      {/* Content wrapper */}
      <div
        className="p-6 md:p-8 flex flex-col flex-grow text-left"
      ...
      >
        ...
        <div className="mt-6 pt-5 border-t border-white/10 flex items-center justify-between">
          ...
          >
            <Github
              size={16}
              className="text-slate-400 group-hover/link:text-white transition-colors"
            />
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h3 className="text-xs font-semibold tracking-widest text-brand-green uppercase mb-2">
          My Creative Works
        </h3>
